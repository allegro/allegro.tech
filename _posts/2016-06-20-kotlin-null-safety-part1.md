...
Therefore at [Allegro](https://allegro.tech/about-us/) we decided to give it a chance — we built our new
...
As we can see there is little difference with `let` — Kotlin code is similar although

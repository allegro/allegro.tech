...
JUnit's <code>@Test</code> annotation has <code>expected</code> attribute which can be set to a Class object of an exception that is expected to be thrown from 

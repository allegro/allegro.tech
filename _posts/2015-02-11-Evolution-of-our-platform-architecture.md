...
[Anti-Corruptions Layer]({{site.baseurl}}{% post_url 2015-01-21-working-with-legacy-architecture %}),
...
[Anti-Corruptions Layers]({{site.baseurl}}{% post_url 2015-01-21-working-with-legacy-architecture %}) to make sure that

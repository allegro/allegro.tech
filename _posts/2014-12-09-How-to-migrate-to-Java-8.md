...
There are also a lot of [unit](http://allegro.tech/java-testing-toolbox.html) and
[integration tests](http://allegro.tech/testing-restful-service-and-clients.html) and test coverage is pleasantly high,
...
Java 8 may have introduced changes to the way [objects are represented internally](http://allegro.tech/The-memory-game.html),

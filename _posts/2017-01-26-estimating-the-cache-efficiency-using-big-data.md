...
[Allegro]({{site.baseurl}}{% link /about-us/ %} ) is the largest e-commerce site in Central Europe. Every day you can browse and
...
![Items count as a function of finds count]({% link /img/articles/2016-12-09-estimating-the-cache-efficiency-using-big-data/items_chart.png %})
...
![SELECTs count as a function of finds count]({% link /img/articles/2016-12-09-estimating-the-cache-efficiency-using-big-data/requests_chart.png %})
...
![cache hit ratio as a function of fraction of items in cache]({% link /img/articles/2016-12-09-estimating-the-cache-efficiency-using-big-data/cache_hits_vs_items_in_cache.png %})
...
![Caching alghoritm with counters]({% link /img/articles/2016-12-09-estimating-the-cache-efficiency-using-big-data/algorithm_with_counters.png %})
...
![Items cache efficiency in production]({% link /img/articles/2016-12-09-estimating-the-cache-efficiency-using-big-data/efficiency.png %})
...
![Version with counters vs without counters]({% link /img/articles/2016-12-09-estimating-the-cache-efficiency-using-big-data/counters_comparison.png %})

...
The tool has been continually developed and successfuly used for over a year at [Allegro]({{site.baseurl}}{% link /about-us/ %} ) to manage
...
[Allegro]({{site.baseurl}}{% link /about-us/ %} ) consists of very many microservices. Each microservice utilizes physical servers, cloud

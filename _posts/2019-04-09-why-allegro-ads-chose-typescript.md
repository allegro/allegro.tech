...
## The Beginning
The Allegro Ads project goal is to enable sellers at [Allegro]({{ '/about-us' | prepend: site.url }}) to advertise their offers. 2017 was a breakthrough year for it.
...
## TypeScript, Flow?
<img alt="TypeScript, Flow" src="{{site.baseurl}}/{% link /img/articles/2019-04-09-why-allegro-ads-chose-typescript/ts-vs-flow.png %}"" />
...
<img alt="npm trends" src="{{site.baseurl}}/{% link /img/articles/2019-04-09-why-allegro-ads-chose-typescript/npm-trends.png %}"" />
...
<img alt="TypeScript files" src="{{site.baseurl}}/{% link /img/articles/2019-04-09-why-allegro-ads-chose-typescript/files-comparison.png %}"" />
...
<img alt="Compilation" src="{{site.baseurl}}/{% link /img/articles/2019-04-09-why-allegro-ads-chose-typescript/compiling.png %}"" />
<img alt="Autocomplete" src="{{site.baseurl}}/{% link /img/articles/2019-04-09-why-allegro-ads-chose-typescript/autocomplete.png %}"" />
...
<img alt="Record class from Immutable.js error" src="{{site.baseurl}}/{% link /img/articles/2019-04-09-why-allegro-ads-chose-typescript/error.png %}"" />

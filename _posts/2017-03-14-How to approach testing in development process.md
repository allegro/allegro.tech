...
This is important skill as not all projects engage UX specialists. If such role is missing, this is tester’s job to give feedback regarding application’s look and feel and how it may be received by end users. What is more, we should never forget about another factor that affects application perception by end users – the performance. Good looking but slow working application will just irritate users, even if all functionalities are working correctly and there is not single trivial bug was left opened after acceptance testing.
...
<ol>
<li>They’re faster and more effective</li>
